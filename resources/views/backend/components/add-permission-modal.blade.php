<div class="modal custom-modal fade" id="add_permission" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            ...
            <form action="{{route('permissions.update',$role->name)}}" method="post">
              @csrf
              @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="input-block mb-0">
                                <label>Search Permissions <span class="text-danger">*</span></label>
                                <select class="form-control permissions" name="permissions[]" multiple="multiple">
